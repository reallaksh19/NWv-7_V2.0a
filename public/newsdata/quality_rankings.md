...
- Overall status: **FAIL**
- Overall score: `0.3043`

## Destination scores

| Destination | Status | Score | Profile | Ranked items |
|---|---|---:|---|---:|
| upAhead | WARN | 0.8557 | `upAhead-v2-lifecycle-location-category` | 30 |
| buzz | FAIL | 0.0 | `buzz-v2-trend-local-travel` | 0 |
| localTravel | FAIL | 0.0 | `localTravel-v1-location-utility-disruption` | 0 |
| insight | WARN | 0.3614 | `insight-v2-event-angle-tree` | 5 |

## Findings

- 27 invalid/expired/duplicate Up Ahead item(s) suppressed
